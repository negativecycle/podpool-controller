...
type PodPoolSpec struct {
	...
	// foo is an example field of PodPool. Edit podpool_types.go to remove/update
	// +optional
...
type PodPool struct {
	...
	// spec defines the desired state of PodPool
	// +required
	Spec PodPoolSpec `json:"spec"`

	// status defines the observed state of PodPool
	// +optional
